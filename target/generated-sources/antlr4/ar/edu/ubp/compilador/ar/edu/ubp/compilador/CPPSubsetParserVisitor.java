...
public interface CPPSubsetParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitDoubleLiteralExpr(CPPSubsetParser.DoubleLiteralExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAddSubExpr(CPPSubsetParser.AddSubExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIntLiteralExpr(CPPSubsetParser.IntLiteralExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCompExpr(CPPSubsetParser.CompExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCallExpr(CPPSubsetParser.FunctionCallExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCharLiteralExpr(CPPSubsetParser.CharLiteralExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMulDivExpr(CPPSubsetParser.MulDivExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitParenExpr(CPPSubsetParser.ParenExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIdExpr(CPPSubsetParser.IdExprContext ctx);
	/**
